...
<div class="login-page">
	<div class="login-content">
		...
		<p>
			...
			consecutive wins! Achieve three consecutive wins to earn a bonus point,
			then watch as your streak resets to start the challenge again.
		</p>
		<p>
		...
		<div class="sign-in-button">
			...
			{:else}
				<h1 class="text-red-color">
					Cannot login! No provider config, please check the config file.
				</h1>
			{/if}
		</div>
	</div>
